...
public class EmailUtils2 {
	...
	private Folder folder;
	   ...
	   */
	  public EmailUtils2() throws MessagingException {
	   ...
	   * @throws MessagingException
	   */
	  public EmailUtils2(EmailFolder emailFolder) throws MessagingException {
	   ...
	   * @param emailFolder Folder in email application to interact with
	   */
	  public EmailUtils2(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
	    Properties props = System.getProperties();
	    try {
	      props.load(new FileInputStream(new File("C:\\Users\\LAKSHMI SRI\\eclipse-workspace\\DomesticRealtyProject\\src\\test\\java\\org\\testng\\maven\\test\\email.properties")));
	    } catch(Exception e) {
	      e.printStackTrace();
	      System.exit(-1);
	    }
	...
	//************* EMAIL ACTIONS *******************
	  ...
	  public boolean isMessageRead(Message message) throws Exception {
		    return message.isSet(Flags.Flag.SEEN);
		  }
}

...
public class CasaGrande extends BaseClass {
	...
	public void screenShot(ITestResult casaGrandeResult) {
		...
		if (ITestResult.FAILURE == casaGrandeResult.getStatus()) {
			try {
				...
				FileUtils.copyFile(src, new File("C:\\Users\\LAKSHMI SRI\\Desktop\\Domestic Reality\\Reports\\" + casaGrandeResult.getName() + ".png"));

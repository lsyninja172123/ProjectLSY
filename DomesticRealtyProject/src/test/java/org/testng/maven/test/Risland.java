...
public class Risland extends BaseClass {
	...
	public void screenShot(ITestResult rislandResult) {
		// using ITestResult.FAILURE is equals to result.getStatus then it enter into if
		// condition
		if (ITestResult.FAILURE == rislandResult.getStatus()) {
			try {
				...
				FileUtils.copyFile(src, new File("C:\\Users\\LAKSHMI SRI\\Desktop\\Domestic Reality\\Reports\\" + rislandResult.getName()+"RislandResult" + ".png"));
